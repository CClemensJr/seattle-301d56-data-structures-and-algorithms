...
const oddValues = (arr) => arr.filter((num) => (num % 2 !== 0) ? num : console.log('Not odd'));
...
const filterStringsWithVowels = (arr) => arr.filter((str) => (str.match(/[aeiou]/) ? str : console.log('No vowels')));
...
const notInFirstArray = (forbiddenValues, arr) => arr.filter((val) => (!forbiddenValues.includes(val)) ? val : console.log('In first array'));
...
const getBaseStatGreaterThan = (arr, minBaseStat) => arr.filter((obj) => (obj.baseStat > minBaseStat) ? obj : console.log('The basestat was not greater'));
...
const getStatName = (arr, minBaseStat) => arr.filter((obj) => (obj.baseStat > minBaseStat) ? obj.stat.name : console.log('The basestat was not greater'));
...
const getCharactersWithoutChildren = (arr) => arr.filter((character) => (!character.children) ? character : console.log(`${ character } has kids.`));
